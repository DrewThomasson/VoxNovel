...
13. `cd VoxNovel`
14. `pip install tts`
15. `pip install booknlp`
16. `pip install -r linux_requirements.txt`
17. `pip3 install spacy`
18. `python3 -m spacy download en_core_web_sm`
19. `pip install pygame`
20. `pip install moviepy`
21. `pip install epub2txt`
